...
import Hevri from "../assets/Hevri.png";
  ...
  const items = [
    {
      ...
      proIntro: "Enjoy your movies and movie information",
      proLink: "https://dazzling-bavarois-3c5bfb.netlify.app/",
      aos: "fade-left",
      offset: "150",
      easing: "ease-in-sine",
      duration: "2000",
    },
    {
      ...
      proBackground:
        "absolute flex items-center justify-center w-full opacity-[0.8] h-full bg-[#182862] rounded-[20px]",
      proIntro:
        "Finding the right school shouldn’t be hard. From the college of education, polytechnic and University, we provide the necessary information to ease your decision-making in finding the right school for you.",
      proLink: "https://hevrinstitution.netlify.app/",
      aos: "fade-left",
      offset: "150",
      easing: "ease-in-sine",
      duration: "2000",
                ...
                {isHovered === item.id ? (
                  <div className="relative flex items-center justify-center w-full h-64 bg-[#223a44] rounded-[20px] border-[1px] border-[#ffffff] px-7 md:h-72">
                    <div className="flex flex-col items-center justify-center w-full">
                      ...
                      <a
                        className="flex items-center justify-center w-40 h-11 mt-7 border-2 border-[#ffffff] rounded-3xl hover:bg-[#ffffff] xl:w-44 xl:h-12"
                        href={item.proLink}
                        target="_blank"
                        rel="noreferrer"
                      >
